...
weights1 = torch.rand(2,1,2,3, requires_grad=False)*10-5
...
weights2 = torch.rand(2,3,2,3, requires_grad=False)*10-5
...
weights3 = torch.rand(2,5,5,4, requires_grad=False)*10-5
biases3 = torch.rand(2)*10-5
